...
function MainContent({ isDarkMode }: MainContentProps): JSX.Element {
        ...
        {selectedCountry ? (
          <div className={styles.countryDetails}>
            ...
            <div className={styles.detailedCountry}>
              ...
              {selectedCountry.borders && selectedCountry.borders.length > 0 ? (
                selectedCountry.borders.map((borderCode) => {
                  const borderCountry = findCountryByAlpha3Code(borderCode);
                  return (
                    <button 
                      key={borderCode} 
                      onClick={() => borderCountry && handleCountryClick(borderCountry)}
                      className={styles.borderCountryButton}
                    >
                      {borderCountry ? borderCountry.name : borderCode}
                    </button>
          ...
          <div className={styles.cardsContainer}>
            {filteredCountries.length > 0 ? (
              ...
              <p className={styles.notFound}>Country not found</p>
            )}
          </div>
        )}
      </div>
